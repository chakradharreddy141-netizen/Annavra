  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-xs text-[#6b7280] mt-0.5">Start your disciplined health and nutrition journey</p>
      </div>
      ...
      <p className="mt-6 text-center text-xs text-[#6b7280]">
        ...
        <Link href="/login" className="text-[#ff4500] hover:text-[#e63e00] font-medium">
          Sign in
        </Link>
      </p>
    </div>
